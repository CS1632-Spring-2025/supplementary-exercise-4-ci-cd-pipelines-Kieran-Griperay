...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		this.r = RentACat.createInstance(InstanceType.IMPL);
		...
		this.c1 = Cat.createInstance(InstanceType.MOCK, 1, "Jennyanydots");
		...
		this.c2 = Cat.createInstance(InstanceType.MOCK, 2, "Old Deuteronomy");
		// 4. Create a Cat with ID 3 and name "Mistoffelees", assign to c3 using a call to Cat.createInstance(InstanceType, int, String).
		this.c3 = Cat.createInstance(InstanceType.MOCK, 3, "Mistoffelees");
	...
	public void testGetCatNumCats3() throws Exception{
		...
		Cat catResult = (Cat) result;
		assertEquals(catResult.getId(), 2);
	}
